...
call :verify_service 5000 "CodeProject AI Server"
goto end
...
call :verify_service 47334 "MindsDB Server"
goto end
...
call :verify_service 5001 "App CodeProject AI Server"
goto end
...
call :verify_service 5002 "App MindsDB Server"
goto end
